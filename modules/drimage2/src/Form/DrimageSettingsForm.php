...
namespace Drupal\drimage2\Form;
...
class DrimageSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['threshold'] = [
      ...
      '#default_value' => $this->config('drimage2.settings')->get('threshold'),
    ...
    $form['ratio_distortion'] = [
      ...
      '#default_value' => $this->config('drimage2.settings')->get('ratio_distortion'),
    ...
    $form['downscale'] = [
      ...
      '#default_value' => $this->config('drimage2.settings')->get('downscale'),
    ...
    $form['upscale'] = [
      ...
      '#default_value' => $this->config('drimage2.settings')->get('upscale'),
    ...
    $form['multiplier'] = [
      ...
      '#default_value' => $this->config('drimage2.settings')->get('multiplier'),
    ...
    $form['lazy_offset'] = [
      ...
      '#default_value' => $this->config('drimage2.settings')->get('lazy_offset'),
    ...
    $form['fallback_style'] = [
      ...
      '#default_value' => $this->config('drimage2.settings')->get('fallback_style'),
    ...
    $this->moduleHandler->alter('drimage2_proxy_cache_periods', $period);
    ...
    $form['proxy_cache_maximum_age'] = [
      ...
      '#default_value' => $this->config('drimage2.settings')->get('proxy_cache_maximum_age'),
      '#options' => $period,
